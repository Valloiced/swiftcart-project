        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img 
                src="/designs/logo-solid.png" 
                alt="SwiftCart Logo" 
                className="h-8 w-auto rounded-lg"
              />
              <h3 className="text-xl font-bold">SwiftCart</h3>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products?category=smartphones" className="text-gray-400 hover:text-white transition duration-300">
                  Smartphones
                </Link>
              </li>
              <li>
                <Link to="/products?category=laptops" className="text-gray-400 hover:text-white transition duration-300">
                  Laptops
                </Link>
              </li>
              <li>
                <Link to="/products?category=fragrances" className="text-gray-400 hover:text-white transition duration-300">
                  Fragrances
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-400 text-sm">Katapatan Homes, Brgy. Katapatan, Cabuyao City</p>
                  <p className="text-gray-400 text-sm">Laguna, Philippines</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-400 text-sm">support@swiftcart.com</p>
              </div>
