            ...
            {user ? ( 
                <div className="relative"> 
                    <button onClick={() => setIsUserMenuOpen(!isUserMenuOpen)} className="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition duration-300">
                        <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justifycenter text-white text-sm font-medium">
                    ...
                    {isUserMenuOpen && (
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py1 z-50">
                            ...
                            <button onClick={handleLogout} className="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bgred-50" > Sign Out </button>
                        </div>
                    )}
                </div>
            ) : (
